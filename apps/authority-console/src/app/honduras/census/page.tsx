    ...
    <div>
      <div className="space-y-8">
        ...
        <div className="grid gap-8 xl:grid-cols-2">
          <div className="space-y-8">
            <DniLookup
              lookupDniAction={lookupDniAction}
              authorizeVoterAction={authorizeVoterAction}
              dniQuery={dniQuery}
              ...
              electionById={electionById}
            />

            <RegistryForms
              upsertCensusRecordAction={upsertCensusRecordAction}
              bulkImportCensusAction={bulkImportCensusAction}
              upsertWalletLinkAction={upsertWalletLinkAction}
            />
          </div>
        </div>
      </div>
