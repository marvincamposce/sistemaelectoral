...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface IElectionRegistryTallyRecorderInterface extends Interface {
    getFunction(nameOrSignature: "recordTallyProofVerification"): FunctionFragment;
  ...
  export interface IElectionRegistryTallyRecorder extends BaseContract {
    
    connect(runner?: ContractRunner | null): IElectionRegistryTallyRecorder;
    waitForDeployment(): Promise<this>;

    interface: IElectionRegistryTallyRecorderInterface;
